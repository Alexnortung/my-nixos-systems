...
static const char col_red[]         = "#7d1e2e";
static const char col_astronaut_pixel_blue[] = "#6d7196";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_astronaut_pixel_blue,  col_astronaut_pixel_blue  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_astronaut_pixel_blue, "-sf", col_gray4, NULL };
